# c:\Users\Vikram\OneDrive\Desktop\meta\openenv-submission\env_b_code_review\inference.py
import os
import sys
import requests
import json
...
ENV_NAME = "code-review-bug-fixing-env"
...
Your JSON must match the exact schema specified in the instruction."""

def run_inference():
    tasks = ["bug_detection", "security_review", "full_pr_review"]
    ...
    for task in tasks:
        ...
        try:
            ...
            log_step(1, "review_submission", reward, done, None)
